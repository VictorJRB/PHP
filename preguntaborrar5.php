...
cabecera("Borrar Zona", "<img class=text-center src=''> ");
...
if(isset ($_GET['id']) && is_numeric($_GET['id'])) {
   ...
   // $stmt = $pdo->query($sql);
    ...
    echo "<div><h2 style='color: white; text-align: center;'>¿Estás seguro/a de que quieres borrar la zona ".$row['nombre'] ."?</h2></div>";
            echo '
            <a class="btn btn-info" style="margin-left:45%; margin-top:10%; font-size:20px;" href="borrarzona.php?id='.$row['id'].'">
               Si
...
?>
<a style="margin-top: 10%; font-size:20px;" href="zona.php" class="btn btn-info">No</a>
<?php
pie()
?>
