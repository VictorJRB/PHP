...
if(isset ($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $sql= "SELECT incidencia_reparada.*, usuarios.nombre as id_tecnico, planta.nombre as id_planta, zona.nombre as id_zona, modulo.nombre as id_modulo, incidencia.nombre as id_incidencia
           ...
           LEFT JOIN incidencia ON incidencia_reparada.id_incidencia=incidencia.id
           HAVING id = ".$_GET['id'];
   ...
   // $stmt = $pdo->query($sql);
    ...
    echo "<div><h2 style='color: white; text-align: center;'>¿Estás seguro/a de que quieres borrar esta incidencia reparada del módulo ".$row['id_modulo'] ."?</h2></div>";
            echo '
            <a class="btn btn-info" style="margin-left:45%; margin-top:10%; font-size:20px;" href="borrarincidencia2.php?id='.$row['id'].'">
               Si
...
?>
<a style="margin-top: 10%; font-size:20px;" href="incidencias-reparadas.php" class="btn btn-info">No</a>
<?php
pie()
?>
