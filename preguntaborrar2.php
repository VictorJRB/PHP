...
if(isset ($_GET['id']) && is_numeric($_GET['id'])) {
   ...
   // $stmt = $pdo->query($sql);
    ...
    echo "<div><h2 style='color: white; text-align: center;'>¿Estás seguro/a de que quieres poner como crónica esta incidencia del módulo ".$row['id_modulo'] ."?</h2></div>";
            echo '
            <a class="btn btn-info" style="margin-left:45%; margin-top:10%; font-size:20px;" href="inci-cronica.php?id='.$row['id'].'">
               Si
