...
cabecera("Ver Incidencia", "<img src=''>");
...
try {
   ...
   // $stmt = $pdo->query($sql2);
    $stmt->setFetchMode(PDO::FETCH_ASSOC);
     ...
     $row = $stmt->fetch();
       ...
       // echo "<td style='background-color: lightgray;' class='text-center'><img src='imagenes/libros/".$row['imagen'] . "' alt='Imagen del libro' width='120'></td>"."";
        ...
        echo "<td><b>Hora</b></br> ".$row['hora']."</td>". "</br>";
        echo "<td><b>Incidencia</b></br> ".$row['id_incidencia']."</td>". "</br>";
        echo "<td><b>Subincidencia</b></br> ".$row['id_subincidencia']."</td>". "</br>";
        echo "</tr>";
        echo "<tr>";

        echo "<td colspan='2' style='background-color:white; height:80px; background-color:silver; color:white;'><b>Observación:</b><br> ".nl2br($row['observacion'])."</td>". "</br>";
        echo "</tr>";
        echo "<tr>";
        echo "<td colspan='2'  style='background-color:white; height:150px; background-color:silver; color:white;'><b>Historial:</b><br> ".nl2br($row['historial'])."</td>". "</br>";
        echo "</tr>";
        echo "</table>";

      //  if ($row['finalizacion']== 0000-00-00) {
        //    echo "<td><h3 class='text-center' style='background-color: greenyellow;'>LIBRO DISPONIBLE</h3></td>";
          //  echo "<a href='libroreservado.php?id=".$row['id']."' class='btn btn-info'>
        //RESERVAR LIBRO</a>";
        //}

        //if ($row['finalizacion']!= 0000-00-00) {
         //   echo "<td><h3 class='text-center' style='background-color: red;'>LIBRO NO DISPONIBLE</h3></td>";
           // echo "&nbsp<a href='../biblioteca/libros.php' class='btn btn-info'>VOLVER</a>";
           // exit;
        //}
    ...
    $stmt = null;
        ...
        echo "&nbsp<a href='incidencias-generales.php' class='btn btn-info'>VOLVER</a>";
